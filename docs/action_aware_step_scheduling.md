...
| Q12 | What did the action stream actually look like?      | Real Minecraft from open-oasis sample data: 961 effective entries (after load_actions prepend). Three-mode distribution: ~60% idle (                                                                                                                                                                                        |
